...
/**
 * Badge variants for category/label pills. Colors resolve from theme tokens;
 * the `secondary`/`accent` (yellow) variants pair with a dark foreground token
 * so text on the gold accent meets contrast requirements.
 */
